...
================================================================================
This version contains the following fixes to solve the "Missing inputs: src, tgt" error:

1.  The pipeline task is set to 'text2text-generation' to match your
    sequence-to-sequence model's architecture.
